...
/// Vista con los detalles de una [lista] dada. También muestra un [FlutterMap]
/// con los elementos que tienen la posición guardada y un [ListView] de los
/// elementos para acceder a los detalles de cada uno (o eliminarlos de la
/// lista)
...
const List<Choice> choices = const <Choice>[
  const Choice(title: Strings.exportar, icon: Icons.share),
  const Choice(title: Strings.eliminar, icon: Icons.delete)
];
...
class _VistaListaState extends State<VistaLista> {
  ...
  /// Crea los [_markers] dependiendo de los [widget.lista.elementos]
  ...
  /// Calcula el centroide de todos [markers] para que el [FlutterMap] se centre
  /// Devuelve las coordenadas del centroide
  ...
  void _select(Choice choice) {
    ...
    setState(() {
      ...
      switch (_selectedChoice.title) {
        case Strings.exportar:
          FlutterClipboard.copy(jsonEncode(widget.lista));
          Toast.show(Strings.copiadoPortapapeles, context);
          break;
        case Strings.eliminar:
                                            ...
                                            if (marker.point ==
                                              ...
                                              return Card(
                                                ...
                                                trailing: IconButton(
                                                  ...
                                                  onPressed: () {
                                                    Utils().openUrl(
                                                        "http://maps.google.com/maps?daddr=${widget.lista.elementos[i].posicion.latitude}, ${widget.lista.elementos[i].posicion.longitude}");
                                                  },
                                                ),
                                              ));
                                            }
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                              '${widget.lista.elementos[index].DB_NOMBRE} · ${widget.lista.elementos[index].DB_NOMBRE != Archivo.NOMBRE ? widget.lista.elementos[index].provincia : widget.lista.elementos[index].localidad}'),
                        ),
                      ));
                    })
              ],
