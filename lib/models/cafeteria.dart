...
/// Representación de una Cafetería
/// https://datosabiertos.jcyl.es/web/jcyl/set/es/turismo/cafeterias/1284211834052
class Cafeteria {
  static const String CSV = "https://datosabiertos.jcyl.es/web/jcyl/risp/es/turismo/cafeterias/1284211834052.csv";
  static const String NOMBRE = "Cafeterias";
  final String DB_CONSULTA_BASICA = """
  SELECT * FROM Cafeterias ORDER BY numero_registro;
  """;
  ...
  /// Crea un objeto Cafeteria a partir de una lista de datos obtenidos a través del
  /// archivo CSV. Si no existe un dato lo marca con -1
  Cafeteria.fromCsv(List<dynamic> datos){
    ...
    if (datos[17] == "" || datos[18] == "")
      ...
      // TODO solucionar problema (distinto tamaño de Lista)
      try {
        this._posicion = new LatLng(
            double.parse(datos[18].toString().replaceAll(",", ".")),
            double.parse(datos[17].toString().replaceAll(",", ".")));
      }catch(e){
        this._posicion = new LatLng(-1,-1);
      }
    }
  ...
  Cafeteria.fromMap(Map<dynamic, dynamic> map){
  ...
  @override
  String toString() {
    return 'Cafeteria{_numeroRegistro: $_numeroRegistro, _nombre: $_nombre, _direccion: $_direccion, _municipio: $_municipio, _posicion: $_posicion}';
  }
  ...
  /// Categoría expresada en número de tazas
  /// - 1ª - 2 Tazas
  /// - 2ª - 1 Taza
  /// - 3ª - 3 Tazas
