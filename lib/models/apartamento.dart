...
/// Representación de un apartamento turístico
class Apartamento {
  static const String CSV = "https://datosabiertos.jcyl.es/web/jcyl/risp/es/turismo/apartamentos/1284211832109.csv";
  static const String NOMBRE = "Apartamentos";
  ...
  /// Crea un objeto Apartamento a partir de una lista de datos obtenidos a través del
  /// archivo CSV. Si no existe un dato lo marca con -1
  Apartamento.fromCsv(List<dynamic> datos){
  ...
  Apartamento.fromMap(Map<dynamic, dynamic> map){
