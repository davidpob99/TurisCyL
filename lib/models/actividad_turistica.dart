...
/// Representación de una empresa que ofrecen otras actividades turísticas
class ActividadTuristica {
  static const String CSV =
      "https://datosabiertos.jcyl.es/web/jcyl/risp/es/turismo/actividad_turistica/1284211838328.csv";
  static const String NOMBRE = "ActividadesTuristicas";
  ...
  ActividadTuristica.vacio();

  /// Crea un objeto ActividadTurstica a partir de una lista de datos obtenidos a través del
  /// archivo CSV. Si no existe un dato lo marca con -1
  ActividadTuristica.fromCsv(List<dynamic> datos) {
  ...
  ActividadTuristica.fromMap(Map<dynamic, dynamic> map) {
