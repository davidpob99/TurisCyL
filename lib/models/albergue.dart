...
/// Representación de un albergue turístico
class Albergue {
  static const String CSV = "https://datosabiertos.jcyl.es/web/jcyl/risp/es/turismo/albergues_turisticos/1284211830763.csv";
  static const String NOMBRE = "Albergues";
  ...
  /// Crea un objeto Albergue a partir de una lista de datos obtenidos a través del
  /// archivo CSV. Si no existe un dato lo marca con -1
  Albergue.fromCsv(List<dynamic> datos){
  ...
  Albergue.fromMap(Map<dynamic, dynamic> map){
