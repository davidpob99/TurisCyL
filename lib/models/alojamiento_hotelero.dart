...
/// Representación de un alojamiento hotelero
class AlojamientoHotelero {
  static const String CSV = "https://datosabiertos.jcyl.es/web/jcyl/risp/es/turismo/alojamientos_hoteleros/1284211831639.csv";
  static const String NOMBRE = "AlojamientosHoteleros";
  ...
  AlojamientoHotelero.vacio();

  /// Crea un objeto AlojamientoHotelero a partir de una lista de datos obtenidos a través del
  /// archivo CSV. Si no existe un dato lo marca con -1
  AlojamientoHotelero.fromCsv(List<dynamic> datos){
  ...
  AlojamientoHotelero.fromMap(Map<dynamic, dynamic> map){
